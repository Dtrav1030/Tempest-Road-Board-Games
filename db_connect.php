<?
    ...
    $PayPalReturnURL    = 'http://travelsteadportfolio.com/A/process.php'; //Point to process.php page
    $PayPalCancelURL    = 'http://travelsteadportfolio.com/A/home.php'; //Cancel URL if user clicks cancel
	...
	$mysqli = new mysqli("localhost" /*host*/,"root" /*username*/,"mysql" /*password*/,"tempest_road" /*database*/);
